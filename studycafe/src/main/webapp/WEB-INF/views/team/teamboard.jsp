		...
		<div>
			...
			<p class="pagination" align="center">
				...
				<c:if test="${page.first == false }">
					<span><a class="page-link" href="?page=0">처음</a></span>
				</c:if>

				<!-- prev -->
				<c:if test="${page.previous == true }">
					<span><a class="page-link" href="?page=${page.number-1 }">이전</a></span>
				</c:if>
				...
				<c:if test="${page.next == true }">
					<span><a class="page-link" href="?page=${page.number+1 }">다음</a></span>
				</c:if>

				<!-- last -->
				<c:if test="${page.last == false }">
					<span><a class="page-link" href="?page=${page.totalPages-1 }">마지막</a></span>
				</c:if>
