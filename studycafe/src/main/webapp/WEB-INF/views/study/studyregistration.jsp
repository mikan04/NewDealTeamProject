			...
			<form action="/studyregistrationpro" name="studyregistration_form" method="post" enctype="multipart/form-data">
				...
				<div class="map_wrap" align="center">
					...
					<div id="menu_wrap" class="bg_white">
						<div class="option">
							<div>
								<input type="text" id="keyword" size="15" placeholder="검색어를 입력해주세요." onkeydown="return preventSubmit(event)" />
				...
				<p>
					...
					<input type="date" id="reserveDate" name="reserveDate" min="2023-07-01" onchange="selectDateHandler(this.value)" />
					...
					<div id="accordion">
						<div class="card">
							...
							<div id="collapse2" class="collapse show" data-parent="#accordion">
								<div class="card-body">
									<div class="hour-div">
										<div class="accordion-study-time enabled" data-time="08">08:00 ~ 11:00</div>
										<div class="accordion-study-time enabled" data-time="11">11:00 ~ 14:00</div>
										<div class="accordion-study-time enabled" data-time="14">14:00 ~ 17:00</div>
										<div class="accordion-study-time enabled" data-time="17">17:00 ~ 20:00</div>
										<div class="accordion-study-time enabled" data-time="20">20:00 ~ 23:00</div>
									</div>
								</div>
							</div>
							...
							<div id="collapse3" class="collapse show" data-parent="#accordion">
								<div class="card-body">
									<div class="d-flex justify-content-between">
										<div>
											<input type="number" id="numOfMember" name="numOfMember" min="2" max="8" value="2" />
										</div>
									</div>
								</div>
							</div>
